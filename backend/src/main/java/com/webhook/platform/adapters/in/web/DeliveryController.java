...
import com.webhook.platform.adapters.in.web.dto.DeliveryDTOs.DeliveryAttemptResponse;
import com.webhook.platform.adapters.in.web.dto.DeliveryDTOs.DeliveryJobResponse;
import com.webhook.platform.application.service.WebhookDeliveryService;
import com.webhook.platform.domain.entity.DeliveryAttemptEntity;
...
public class DeliveryController {
  ...
  public ResponseEntity<List<DeliveryAttemptResponse>> listAttempts(
      @AuthenticationPrincipal User user, @PathVariable UUID id) {
    // TODO: Validate if job belongs to tenant (omitted for speed, relying on UUID unguessability +
    // future improvements)
  ...
  private DeliveryAttemptResponse toAttemptResponse(DeliveryAttemptEntity entity) {
    boolean success =
        entity.getHttpStatus() != null
            && entity.getHttpStatus() >= 200
            && entity.getHttpStatus() < 300;
